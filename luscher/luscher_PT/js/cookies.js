...
function radar(sumas){
  ...
  ctx.font = "18px Arial";
  ctx.fillText("RELAÇÃO                                   TAREFA", 110, 360);  
  ...
  drawTextAlongArc(ctx, '   Capacidade      Disposição     Perseverança      Energía     ', 300, 300, 225, Math.PI);
...
const myChart = new Chart(ctx, {
  type: 'bar',
  data: {
    labels: ["Estabilidade", "Variabilidade", "", "Autonomia", "Heteromia", "","Integração", "Diferenciação"],
    datasets: [{
      label: 'Columna 1',
      data: columna1,
      borderColor: "cyan",
